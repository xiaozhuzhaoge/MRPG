...
namespace XLua.CSObjectWrap
{
    ...
    public class MBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MBehaviour gen_ret = new MBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MBehaviour constructor!");
        ...
        static int _g_get_path(RealStatePtr L)
        {
		    try {
                ...
                MBehaviour gen_to_be_invoked = (MBehaviour)translator.FastGetCSObj(L, 1);
