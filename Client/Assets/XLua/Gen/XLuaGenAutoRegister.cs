...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(LuaConfigInfo), LuaConfigInfoWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MBehaviour), MBehaviourWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MUIBehaviour), MUIBehaviourWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(MUIMgr), MUIMgrWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MessageCenter), MessageCenterWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ResourceMgr), ResourceMgrWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MobaNetwork), MobaNetworkWrap.__Register);
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(LunaMessage), LunaMessageWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ProtoBufUtils), ProtoBufUtilsWrap.__Register);
